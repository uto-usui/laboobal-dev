import { Scene, OrthographicCamera, Color, WebGLRenderer } from 'three'
 ...
 * set renderer
 */
export class AmoebaCreateRenderer {
  /**
   * constructor
   *
   * @param {wrap} {HTMLCanvasElement}
   *
   * @returns {AmoebaCreateRenderer}
   */
  constructor({ wrap }) {
    this.container = wrap
  ...
  resizeScene() {
    ...
    this.renderer.setSize(this.width, this.height)
    //
    console.log('🔥 AmoebaCreateRenderer resizeScene')
  }
